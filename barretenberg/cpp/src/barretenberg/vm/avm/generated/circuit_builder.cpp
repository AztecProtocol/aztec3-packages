    ...
    AVM_TRACK_TIME(
        "circuit_builder/set_polys_unshifted", ({
            bb::parallel_for(rows.size(), [&](size_t i) {
                ...
                polys.sha256_params_lookup_table_round_constant.set_if_valid_index(
                    i, rows[i].sha256_params_lookup_table_round_constant);
                polys.sha256_params_lookup_table_round_index.set_if_valid_index(
                    i, rows[i].sha256_params_lookup_table_round_index);
                polys.sha256_params_lookup_table_sel.set_if_valid_index(i, rows[i].sha256_params_lookup_table_sel);
                ...
                polys.sha256_a.set_if_valid_index(i, rows[i].sha256_a);
                polys.sha256_a_and_b.set_if_valid_index(i, rows[i].sha256_a_and_b);
                polys.sha256_a_and_b_xor_a_and_c.set_if_valid_index(i, rows[i].sha256_a_and_b_xor_a_and_c);
                polys.sha256_a_and_c.set_if_valid_index(i, rows[i].sha256_a_and_c);
                polys.sha256_a_rotr_13.set_if_valid_index(i, rows[i].sha256_a_rotr_13);
                polys.sha256_a_rotr_2.set_if_valid_index(i, rows[i].sha256_a_rotr_2);
                polys.sha256_a_rotr_22.set_if_valid_index(i, rows[i].sha256_a_rotr_22);
                polys.sha256_a_rotr_2_xor_a_rotr_13.set_if_valid_index(i, rows[i].sha256_a_rotr_2_xor_a_rotr_13);
                polys.sha256_and_sel.set_if_valid_index(i, rows[i].sha256_and_sel);
                polys.sha256_b.set_if_valid_index(i, rows[i].sha256_b);
                polys.sha256_b_and_c.set_if_valid_index(i, rows[i].sha256_b_and_c);
                polys.sha256_c.set_if_valid_index(i, rows[i].sha256_c);
                polys.sha256_ch.set_if_valid_index(i, rows[i].sha256_ch);
                polys.sha256_clk.set_if_valid_index(i, rows[i].sha256_clk);
                polys.sha256_computed_w_lhs.set_if_valid_index(i, rows[i].sha256_computed_w_lhs);
                polys.sha256_computed_w_rhs.set_if_valid_index(i, rows[i].sha256_computed_w_rhs);
                polys.sha256_d.set_if_valid_index(i, rows[i].sha256_d);
                polys.sha256_dummy_zero.set_if_valid_index(i, rows[i].sha256_dummy_zero);
                polys.sha256_e.set_if_valid_index(i, rows[i].sha256_e);
                polys.sha256_e_and_f.set_if_valid_index(i, rows[i].sha256_e_and_f);
                polys.sha256_e_rotr_11.set_if_valid_index(i, rows[i].sha256_e_rotr_11);
                polys.sha256_e_rotr_25.set_if_valid_index(i, rows[i].sha256_e_rotr_25);
                polys.sha256_e_rotr_6.set_if_valid_index(i, rows[i].sha256_e_rotr_6);
                polys.sha256_e_rotr_6_xor_e_rotr_11.set_if_valid_index(i, rows[i].sha256_e_rotr_6_xor_e_rotr_11);
                polys.sha256_f.set_if_valid_index(i, rows[i].sha256_f);
                polys.sha256_g.set_if_valid_index(i, rows[i].sha256_g);
                polys.sha256_h.set_if_valid_index(i, rows[i].sha256_h);
                polys.sha256_helper_w0.set_if_valid_index(i, rows[i].sha256_helper_w0);
                polys.sha256_helper_w1.set_if_valid_index(i, rows[i].sha256_helper_w1);
                polys.sha256_helper_w10.set_if_valid_index(i, rows[i].sha256_helper_w10);
                polys.sha256_helper_w11.set_if_valid_index(i, rows[i].sha256_helper_w11);
                polys.sha256_helper_w12.set_if_valid_index(i, rows[i].sha256_helper_w12);
                polys.sha256_helper_w13.set_if_valid_index(i, rows[i].sha256_helper_w13);
                polys.sha256_helper_w14.set_if_valid_index(i, rows[i].sha256_helper_w14);
                polys.sha256_helper_w15.set_if_valid_index(i, rows[i].sha256_helper_w15);
                polys.sha256_helper_w2.set_if_valid_index(i, rows[i].sha256_helper_w2);
                polys.sha256_helper_w3.set_if_valid_index(i, rows[i].sha256_helper_w3);
                polys.sha256_helper_w4.set_if_valid_index(i, rows[i].sha256_helper_w4);
                polys.sha256_helper_w5.set_if_valid_index(i, rows[i].sha256_helper_w5);
                polys.sha256_helper_w6.set_if_valid_index(i, rows[i].sha256_helper_w6);
                polys.sha256_helper_w7.set_if_valid_index(i, rows[i].sha256_helper_w7);
                polys.sha256_helper_w8.set_if_valid_index(i, rows[i].sha256_helper_w8);
                polys.sha256_helper_w9.set_if_valid_index(i, rows[i].sha256_helper_w9);
                polys.sha256_init_a.set_if_valid_index(i, rows[i].sha256_init_a);
                polys.sha256_init_b.set_if_valid_index(i, rows[i].sha256_init_b);
                polys.sha256_init_c.set_if_valid_index(i, rows[i].sha256_init_c);
                polys.sha256_init_d.set_if_valid_index(i, rows[i].sha256_init_d);
                polys.sha256_init_e.set_if_valid_index(i, rows[i].sha256_init_e);
                polys.sha256_init_f.set_if_valid_index(i, rows[i].sha256_init_f);
                polys.sha256_init_g.set_if_valid_index(i, rows[i].sha256_init_g);
                polys.sha256_init_h.set_if_valid_index(i, rows[i].sha256_init_h);
                polys.sha256_input_offset.set_if_valid_index(i, rows[i].sha256_input_offset);
                polys.sha256_is_input_round.set_if_valid_index(i, rows[i].sha256_is_input_round);
                polys.sha256_latch.set_if_valid_index(i, rows[i].sha256_latch);
                polys.sha256_lhs_a_13.set_if_valid_index(i, rows[i].sha256_lhs_a_13);
                polys.sha256_lhs_a_2.set_if_valid_index(i, rows[i].sha256_lhs_a_2);
                polys.sha256_lhs_a_22.set_if_valid_index(i, rows[i].sha256_lhs_a_22);
                polys.sha256_lhs_e_11.set_if_valid_index(i, rows[i].sha256_lhs_e_11);
                polys.sha256_lhs_e_25.set_if_valid_index(i, rows[i].sha256_lhs_e_25);
                polys.sha256_lhs_e_6.set_if_valid_index(i, rows[i].sha256_lhs_e_6);
                polys.sha256_lhs_w_10.set_if_valid_index(i, rows[i].sha256_lhs_w_10);
                polys.sha256_lhs_w_17.set_if_valid_index(i, rows[i].sha256_lhs_w_17);
                polys.sha256_lhs_w_18.set_if_valid_index(i, rows[i].sha256_lhs_w_18);
                polys.sha256_lhs_w_19.set_if_valid_index(i, rows[i].sha256_lhs_w_19);
                polys.sha256_lhs_w_3.set_if_valid_index(i, rows[i].sha256_lhs_w_3);
                polys.sha256_lhs_w_7.set_if_valid_index(i, rows[i].sha256_lhs_w_7);
                polys.sha256_maj.set_if_valid_index(i, rows[i].sha256_maj);
                polys.sha256_next_a_lhs.set_if_valid_index(i, rows[i].sha256_next_a_lhs);
                polys.sha256_next_a_rhs.set_if_valid_index(i, rows[i].sha256_next_a_rhs);
                polys.sha256_next_e_lhs.set_if_valid_index(i, rows[i].sha256_next_e_lhs);
                polys.sha256_next_e_rhs.set_if_valid_index(i, rows[i].sha256_next_e_rhs);
                polys.sha256_not_e.set_if_valid_index(i, rows[i].sha256_not_e);
                polys.sha256_not_e_and_g.set_if_valid_index(i, rows[i].sha256_not_e_and_g);
                polys.sha256_output_a_lhs.set_if_valid_index(i, rows[i].sha256_output_a_lhs);
                polys.sha256_output_a_rhs.set_if_valid_index(i, rows[i].sha256_output_a_rhs);
                polys.sha256_output_b_lhs.set_if_valid_index(i, rows[i].sha256_output_b_lhs);
                polys.sha256_output_b_rhs.set_if_valid_index(i, rows[i].sha256_output_b_rhs);
                polys.sha256_output_c_lhs.set_if_valid_index(i, rows[i].sha256_output_c_lhs);
                polys.sha256_output_c_rhs.set_if_valid_index(i, rows[i].sha256_output_c_rhs);
                polys.sha256_output_d_lhs.set_if_valid_index(i, rows[i].sha256_output_d_lhs);
                polys.sha256_output_d_rhs.set_if_valid_index(i, rows[i].sha256_output_d_rhs);
                polys.sha256_output_e_lhs.set_if_valid_index(i, rows[i].sha256_output_e_lhs);
                polys.sha256_output_e_rhs.set_if_valid_index(i, rows[i].sha256_output_e_rhs);
                polys.sha256_output_f_lhs.set_if_valid_index(i, rows[i].sha256_output_f_lhs);
                polys.sha256_output_f_rhs.set_if_valid_index(i, rows[i].sha256_output_f_rhs);
                polys.sha256_output_g_lhs.set_if_valid_index(i, rows[i].sha256_output_g_lhs);
                polys.sha256_output_g_rhs.set_if_valid_index(i, rows[i].sha256_output_g_rhs);
                polys.sha256_output_h_lhs.set_if_valid_index(i, rows[i].sha256_output_h_lhs);
                polys.sha256_output_h_rhs.set_if_valid_index(i, rows[i].sha256_output_h_rhs);
                polys.sha256_output_offset.set_if_valid_index(i, rows[i].sha256_output_offset);
                polys.sha256_perform_round.set_if_valid_index(i, rows[i].sha256_perform_round);
                polys.sha256_rhs_a_13.set_if_valid_index(i, rows[i].sha256_rhs_a_13);
                polys.sha256_rhs_a_2.set_if_valid_index(i, rows[i].sha256_rhs_a_2);
                polys.sha256_rhs_a_22.set_if_valid_index(i, rows[i].sha256_rhs_a_22);
                polys.sha256_rhs_e_11.set_if_valid_index(i, rows[i].sha256_rhs_e_11);
                polys.sha256_rhs_e_25.set_if_valid_index(i, rows[i].sha256_rhs_e_25);
                polys.sha256_rhs_e_6.set_if_valid_index(i, rows[i].sha256_rhs_e_6);
                polys.sha256_rhs_w_10.set_if_valid_index(i, rows[i].sha256_rhs_w_10);
                polys.sha256_rhs_w_17.set_if_valid_index(i, rows[i].sha256_rhs_w_17);
                polys.sha256_rhs_w_18.set_if_valid_index(i, rows[i].sha256_rhs_w_18);
                polys.sha256_rhs_w_19.set_if_valid_index(i, rows[i].sha256_rhs_w_19);
                polys.sha256_rhs_w_3.set_if_valid_index(i, rows[i].sha256_rhs_w_3);
                polys.sha256_rhs_w_7.set_if_valid_index(i, rows[i].sha256_rhs_w_7);
                polys.sha256_round_constant.set_if_valid_index(i, rows[i].sha256_round_constant);
                polys.sha256_round_count.set_if_valid_index(i, rows[i].sha256_round_count);
                polys.sha256_rounds_remaining.set_if_valid_index(i, rows[i].sha256_rounds_remaining);
                polys.sha256_rounds_remaining_inv.set_if_valid_index(i, rows[i].sha256_rounds_remaining_inv);
                polys.sha256_s_0.set_if_valid_index(i, rows[i].sha256_s_0);
                polys.sha256_s_1.set_if_valid_index(i, rows[i].sha256_s_1);
                polys.sha256_sel.set_if_valid_index(i, rows[i].sha256_sel);
                polys.sha256_start.set_if_valid_index(i, rows[i].sha256_start);
                polys.sha256_state_offset.set_if_valid_index(i, rows[i].sha256_state_offset);
                polys.sha256_w.set_if_valid_index(i, rows[i].sha256_w);
                polys.sha256_w_15_rotr_18.set_if_valid_index(i, rows[i].sha256_w_15_rotr_18);
                polys.sha256_w_15_rotr_7.set_if_valid_index(i, rows[i].sha256_w_15_rotr_7);
                polys.sha256_w_15_rotr_7_xor_w_15_rotr_18.set_if_valid_index(
                    i, rows[i].sha256_w_15_rotr_7_xor_w_15_rotr_18);
                polys.sha256_w_15_rshift_3.set_if_valid_index(i, rows[i].sha256_w_15_rshift_3);
                polys.sha256_w_2_rotr_17.set_if_valid_index(i, rows[i].sha256_w_2_rotr_17);
                polys.sha256_w_2_rotr_17_xor_w_2_rotr_19.set_if_valid_index(i,
                                                                            rows[i].sha256_w_2_rotr_17_xor_w_2_rotr_19);
                polys.sha256_w_2_rotr_19.set_if_valid_index(i, rows[i].sha256_w_2_rotr_19);
                polys.sha256_w_2_rshift_10.set_if_valid_index(i, rows[i].sha256_w_2_rshift_10);
                polys.sha256_w_s_0.set_if_valid_index(i, rows[i].sha256_w_s_0);
                polys.sha256_w_s_1.set_if_valid_index(i, rows[i].sha256_w_s_1);
                polys.sha256_xor_sel.set_if_valid_index(i, rows[i].sha256_xor_sel);
                ...
                polys.lookup_w_s_0_xor_0_counts.set_if_valid_index(i, rows[i].lookup_w_s_0_xor_0_counts);
                polys.lookup_w_s_0_xor_1_counts.set_if_valid_index(i, rows[i].lookup_w_s_0_xor_1_counts);
                polys.lookup_w_s_1_xor_0_counts.set_if_valid_index(i, rows[i].lookup_w_s_1_xor_0_counts);
                polys.lookup_w_s_1_xor_1_counts.set_if_valid_index(i, rows[i].lookup_w_s_1_xor_1_counts);
                polys.lookup_s_1_xor_0_counts.set_if_valid_index(i, rows[i].lookup_s_1_xor_0_counts);
                polys.lookup_s_1_xor_1_counts.set_if_valid_index(i, rows[i].lookup_s_1_xor_1_counts);
                polys.lookup_ch_and_0_counts.set_if_valid_index(i, rows[i].lookup_ch_and_0_counts);
                polys.lookup_ch_and_1_counts.set_if_valid_index(i, rows[i].lookup_ch_and_1_counts);
                polys.lookup_ch_xor_counts.set_if_valid_index(i, rows[i].lookup_ch_xor_counts);
                polys.lookup_round_constant_counts.set_if_valid_index(i, rows[i].lookup_round_constant_counts);
                polys.lookup_s_0_xor_0_counts.set_if_valid_index(i, rows[i].lookup_s_0_xor_0_counts);
                polys.lookup_s_0_xor_1_counts.set_if_valid_index(i, rows[i].lookup_s_0_xor_1_counts);
                polys.lookup_maj_and_0_counts.set_if_valid_index(i, rows[i].lookup_maj_and_0_counts);
                polys.lookup_maj_and_1_counts.set_if_valid_index(i, rows[i].lookup_maj_and_1_counts);
                polys.lookup_maj_and_2_counts.set_if_valid_index(i, rows[i].lookup_maj_and_2_counts);
                polys.lookup_maj_xor_0_counts.set_if_valid_index(i, rows[i].lookup_maj_xor_0_counts);
                polys.lookup_maj_xor_1_counts.set_if_valid_index(i, rows[i].lookup_maj_xor_1_counts);
