...
class lookup_l2_gas_rng_chk_1_lookup_settings {
  public:
    ...
    {
        return std::forward_as_tuple(in.template get_column<ColumnAndShifts::lookup_l2_gas_rng_chk_1_inv>(),
                                     in.template get_column<ColumnAndShifts::lookup_l2_gas_rng_chk_1_counts>(),
                                     in.template get_column<ColumnAndShifts::main_is_gas_accounted>(),
                                     in.template get_column<ColumnAndShifts::main_sel_rng_16>(),
                                     in.template get_column<ColumnAndShifts::main_l2_gas_u16_r1>(),
