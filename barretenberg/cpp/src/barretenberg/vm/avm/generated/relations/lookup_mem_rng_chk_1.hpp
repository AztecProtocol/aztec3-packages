...
class lookup_mem_rng_chk_1_lookup_settings {
  public:
    ...
    {
        return std::forward_as_tuple(in.template get_column<ColumnAndShifts::lookup_mem_rng_chk_1_inv>(),
                                     in.template get_column<ColumnAndShifts::lookup_mem_rng_chk_1_counts>(),
                                     in.template get_column<ColumnAndShifts::mem_sel_rng_chk>(),
                                     in.template get_column<ColumnAndShifts::main_sel_rng_16>(),
                                     in.template get_column<ColumnAndShifts::mem_u16_r1>(),
