...
class lookup_rng_chk_4_lookup_settings {
  public:
    ...
    {
        return (in.template get_column<ColumnAndShifts::range_check_sel_lookup_4>() == 1 ||
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.template get_column<ColumnAndShifts::range_check_sel_lookup_4>());
    ...
    {
        return std::forward_as_tuple(in.template get_column<ColumnAndShifts::lookup_rng_chk_4_inv>(),
                                     in.template get_column<ColumnAndShifts::lookup_rng_chk_4_counts>(),
                                     in.template get_column<ColumnAndShifts::range_check_sel_lookup_4>(),
                                     in.template get_column<ColumnAndShifts::main_sel_rng_16>(),
                                     in.template get_column<ColumnAndShifts::range_check_u16_r4>(),
