...
class lookup_rng_chk_5_lookup_settings {
  public:
    ...
    {
        return (in.template get_column<ColumnAndShifts::range_check_sel_lookup_5>() == 1 ||
    ...
    static inline auto compute_inverse_exists(const AllEntities& in)
    {
        ...
        const auto is_operation = View(in.template get_column<ColumnAndShifts::range_check_sel_lookup_5>());
    ...
    {
        return std::forward_as_tuple(in.template get_column<ColumnAndShifts::lookup_rng_chk_5_inv>(),
                                     in.template get_column<ColumnAndShifts::lookup_rng_chk_5_counts>(),
                                     in.template get_column<ColumnAndShifts::range_check_sel_lookup_5>(),
                                     in.template get_column<ColumnAndShifts::main_sel_rng_16>(),
                                     in.template get_column<ColumnAndShifts::range_check_u16_r5>(),
