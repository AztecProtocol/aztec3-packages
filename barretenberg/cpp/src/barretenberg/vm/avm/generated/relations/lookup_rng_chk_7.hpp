...
class lookup_rng_chk_7_lookup_settings {
  public:
    ...
    {
        return std::forward_as_tuple(in.template get_column<ColumnAndShifts::lookup_rng_chk_7_inv>(),
                                     in.template get_column<ColumnAndShifts::lookup_rng_chk_7_counts>(),
                                     in.template get_column<ColumnAndShifts::range_check_sel_rng_chk>(),
                                     in.template get_column<ColumnAndShifts::main_sel_rng_16>(),
                                     in.template get_column<ColumnAndShifts::range_check_u16_r7>(),
