...
class perm_main_mem_ind_addr_d_permutation_settings {
  public:
    ...
    {
        return (in.template get_column<ColumnAndShifts::main_sel_resolve_ind_addr_d>() == 1 ||
                in.template get_column<ColumnAndShifts::mem_sel_resolve_ind_addr_d>() == 1);
    }

    template <typename AllEntities> static inline auto get_const_entities(const AllEntities& in)
    {
        return std::forward_as_tuple(in.template get_column<ColumnAndShifts::perm_main_mem_ind_addr_d_inv>(),
                                     in.template get_column<ColumnAndShifts::main_sel_resolve_ind_addr_d>(),
                                     in.template get_column<ColumnAndShifts::main_sel_resolve_ind_addr_d>(),
                                     in.template get_column<ColumnAndShifts::mem_sel_resolve_ind_addr_d>(),
                                     in.template get_column<ColumnAndShifts::main_clk>(),
                                     in.template get_column<ColumnAndShifts::main_space_id>(),
                                     in.template get_column<ColumnAndShifts::main_ind_addr_d>(),
