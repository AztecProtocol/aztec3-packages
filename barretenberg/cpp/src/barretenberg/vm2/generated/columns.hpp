...
#define AVM2_SHIFTED_ENTITIES bitwise_acc_ia_shift, bitwise_acc_ib_shift, bitwise_acc_ic_shift, bitwise_ctr_shift, bitwise_op_id_shift, execution_sel_shift
#define AVM2_TO_BE_SHIFTED(e) e.bitwise_acc_ia, e.bitwise_acc_ib, e.bitwise_acc_ic, e.bitwise_ctr, e.bitwise_op_id, e.execution_sel
...
#define AVM2_TO_BE_SHIFTED_COLUMNS Column::bitwise_acc_ia, Column::bitwise_acc_ib, Column::bitwise_acc_ic, Column::bitwise_ctr, Column::bitwise_op_id, Column::execution_sel
#define AVM2_SHIFTED_COLUMNS ColumnAndShifts::bitwise_acc_ia_shift, ColumnAndShifts::bitwise_acc_ib_shift, ColumnAndShifts::bitwise_acc_ic_shift, ColumnAndShifts::bitwise_ctr_shift, ColumnAndShifts::bitwise_op_id_shift, ColumnAndShifts::execution_sel_shift
// clang-format on
...
constexpr auto NUM_COLUMNS_WITH_SHIFTS = 121;
constexpr auto NUM_COLUMNS_WITHOUT_SHIFTS = 115;
