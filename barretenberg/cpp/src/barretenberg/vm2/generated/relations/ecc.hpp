...
template <typename FF_> class eccImpl {
  public:
                           ...
                           [[maybe_unused]] const FF& scaling_factor)
    {
        ...
        const auto ecc_BOTH_NON_INF = (FF(1) - ecc_BOTH_INF);
        ...
        const auto ecc_COMPUTED_R_Y =
            ((new_term.ecc_lambda * (new_term.ecc_p_x - new_term.ecc_r_x)) - new_term.ecc_p_y);
        const auto ecc_EITHER_INF = ((FF(1) - ecc_BOTH_INF) * (new_term.ecc_p_is_inf + new_term.ecc_q_is_inf));
        const auto ecc_USE_COMPUTED_RESULT = ((FF(1) - ecc_EITHER_INF) * (FF(1) - new_term.ecc_result_infinity));
        ...
        }
        {
            ...
            auto tmp = (new_term.ecc_sel * (((ecc_X_DIFF * ((new_term.ecc_x_match * (FF(1) - new_term.ecc_inv_x_diff)) +
                                                            new_term.ecc_inv_x_diff)) -
                                             FF(1)) +
        ...
        }
        {
            ...
            auto tmp = (new_term.ecc_sel * (((ecc_Y_DIFF * ((new_term.ecc_y_match * (FF(1) - new_term.ecc_inv_y_diff)) +
                                                            new_term.ecc_inv_y_diff)) -
                                             FF(1)) +
        ...
        }
        {
            ...
            auto tmp = (new_term.ecc_result_infinity * (FF(1) - new_term.ecc_result_infinity));
            tmp *= scaling_factor;
        ...
        }
        {
            ...
            auto tmp =
                (new_term.ecc_sel *
                 (new_term.ecc_lambda - (((new_term.ecc_double_op * ((FF(3) * new_term.ecc_p_x) * new_term.ecc_p_x)) *
                                          new_term.ecc_inv_2_p_y) +
        ...
        }
        {
            ...
            auto tmp = ((((new_term.ecc_sel * new_term.ecc_r_x) -
                          (ecc_EITHER_INF *
                           ((new_term.ecc_p_is_inf * new_term.ecc_q_x) + (new_term.ecc_q_is_inf * new_term.ecc_p_x)))) -
        ...
        }
        {
            ...
            auto tmp = ((((new_term.ecc_sel * new_term.ecc_r_y) -
                          (ecc_EITHER_INF *
                           ((new_term.ecc_p_is_inf * new_term.ecc_q_y) + (new_term.ecc_q_is_inf * new_term.ecc_p_y)))) -
...
template <typename FF> class ecc : public Relation<eccImpl<FF>> {
  public:
    ...
    static constexpr size_t SR_INFINITY_RESULT = 13;
    static constexpr size_t SR_COMPUTED_LAMBDA = 15;
