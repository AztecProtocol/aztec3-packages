...
using GrumpkinPoint = simulation::GrumpkinPoint;

namespace {

FF compute_lambda(const bool& double_predicate,
                  const bool& add_predicate,
                  const GrumpkinPoint& p,
                  const GrumpkinPoint& q)
{
    if (double_predicate) {
